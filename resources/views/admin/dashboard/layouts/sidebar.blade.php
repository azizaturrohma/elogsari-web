<head>
    <style>
        .nav-link.active .color-background {
...
<body>
    <nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-white loopple-fixed-start" id="sidenav-main" data-sidebar="true" data-sidebar-value="53">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="javascript:;" style="text-align:center;">
                <img src="../assets/img/logo.png" class="navbar-brand-img h-100" alt="elogsari" style="width: 50px; height:40px; padding-right:5px" />
                <span class="ms-1 font-weight-bold" style="font-size: 15px; color:green">{{ Auth::user()->username }}</span>
            </a>
        </div>
        <div class="text-center">
            <hr style="width: 200px;" class="d-inline-block mt-0">
        </div>

        <!-- Sidebar Items Start -->
        <div style="height: 80vh;" class="collapse navbar-collapse w-auto" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/update-password">
                        <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            navLinks.forEach(function(link) {
                link.addEventListener('click', function() {
                    ...
                    // Save the clicked link in localStorage
