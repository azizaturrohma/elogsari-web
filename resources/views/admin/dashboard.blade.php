...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/admin/dashboard/loopple/loopple.css" />
</head>
...
<body class="g-sidenav-show bg-gray-100">
    <nav class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start position-absolute ms-3 bg-white loopple-fixed-start" id="sidenav-main" data-sidebar="true" data-sidebar-value="53">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="javascript:;">
                <img src="https://loopple.s3.eu-west-3.amazonaws.com/images/bMcDYVAsj2xjQudR6hH7cO7gSNdbTUl5a3p9ooxy.png" class="navbar-brand-img h-100" alt="..." />
    ...
    <!-- Script -->
    <script src="../assets/js/admin/dashboard/loopple/loopple.js"></script>
</body>
