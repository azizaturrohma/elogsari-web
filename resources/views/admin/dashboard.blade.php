...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="../assets/css/admin/dashboard/soft-ui-dashboard.css?v=1.0.7" rel="stylesheet" />
</head>
    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3" id="sidenav-main">
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0" href="javascript:;">
                <img src="https://loopple.s3.eu-west-3.amazonaws.com/images/AccN4DXHbAGR6uEKS3BJd7rg5iGowU0LWn58hG6x.png" class="navbar-brand-img h-100" alt="...">
            ...
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link  active" href="javascript:;">
                        <div class="icon icon-shape icon-sm shadow border-radius-md text-center me-2 d-flex align-items-center justify-content-center bg-success">
                ...
                <li class="nav-item">
                    <a class="nav-link  " href="javascript:;">
                        ...
                        <span class="nav-link-text ms-1">Keamanan</span>
                    </a>
                </li>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        <li class="breadcrumb-item text-sm">
                            <a class="opacity-5 text-dark" href="javascript:;">Elogsari</a>
                        </li>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            by
                            <a href="https://www.instagram.com/p2md.hmjti2023/" class="font-weight-bold" target="_blank">Tim P2MD HMJTI Poliwangi </a>
                    ...
                    <div class="col-lg-6">
                        <ul class="nav nav-footer justify-content-center justify-content-lg-end">
                            <li class="nav-item">
                                <a href="https://mail.google.com/mail/u/0/?view=cm&tf=1&fs=1&to=rumahkreatif.231@gmail.com" class="nav-link text-muted" target="_blank">Email</a>
                            </li>
                            <li class="nav-item">
                                <a href="https://www.instagram.com/p2md.hmjti2023/" class="nav-link text-muted" target="_blank">Instagram</a>
                            </li>
                            <li class="nav-item">
                                <a href="https://www.tiktok.com/@rumahkreatif321" class="nav-link text-muted" target="_blank">Tik Tok</a>
                            </li>
                            <li class="nav-item">
                                <a href="https://maps.app.goo.gl/XtdR2yHJiaBmtae29" class="nav-link pe-0 text-muted" target="_blank">Google Maps</a>
                            </li>
                        </ul>
                    </div>
                </div>
